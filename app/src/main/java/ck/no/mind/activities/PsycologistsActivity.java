...
/** TODO
 * Add a real data from the real API. Currently not available to show all the psycologists in the city.
 */
...
public class PsycologistsActivity extends AppCompatActivity {
    ...
    String[] maintitle ={
            "Dr. Elenita Boes","Dr. Mette Mirelle Østerud",
            "Dr. Carlota Kelly","Dr. Zhao Huang",
            "Dr. George Owusu",
    };
    ...
    Integer[] imgid = {
            R.drawable.psycologist_1,R.drawable.psycologist_2,
            R.drawable.psycologist_3,R.drawable.psycologist_4,
            R.drawable.psycologist_5,
    };

    Integer[] stars = {
            R.drawable.star_5,R.drawable.star_5,
            R.drawable.star_4,R.drawable.star_5,
            R.drawable.star_4,
    };
    @Override
